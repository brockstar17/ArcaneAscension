...
public class PacketRequestUpdateAltar implements IMessage
{
	...
	public static class Handler implements IMessageHandler<PacketRequestUpdateAltar, PacketUpdatedAltar>
	{

		@Override
		public PacketUpdatedAltar onMessage(PacketRequestUpdateAltar message, MessageContext ctx) {
			...
			if (te != null) {
				return new PacketUpdatedAltar(te);
			}
			else {
				return null;
			}
